...
export function generateGabinetesExcel(
  ...
  const rows = gabinetes.map((gab) => ({
    ...
    "Tipo": gab.tipo || "N/A",
    "Proteção": gab.protecao || "N/I",
    "Status": gab.ativo || "Ativo",
    "Tecnologias Acesso": gab.tecnologiasAcesso || "",
    "Tecnologias Transporte": gab.tecnologiasTransporte || "",
    "FCC Fabricante": gab.fccFabricante || "",
    "FCC Tensão": gab.fccTensao || "",
    "FCC Gerenciado": gab.fccGerenciado || "",
    "FCC Gerenciável": gab.fccGerenciavel || "",
    "FCC Consumo": gab.fccConsumo || "",
    "URs Suportadas": gab.fccQtdUr || "",
    "URs Instaladas": gab.fccQtdUrInstaladas || "",
    "Climatização Tipo": gab.climatizacaoTipo || "",
    "Ventiladores": gab.ventiladoresStatus || "",
    "PLC": gab.plcStatus || "",
    "Alarme": gab.alarmeStatus || "",
    "Bancos Interligados": gab.bancosInterligados || "",
